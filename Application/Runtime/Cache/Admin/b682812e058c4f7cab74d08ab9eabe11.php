...
<script type="text/javascript" charset="utf-8" src="javascripts/graphDemo.js"></script>
     ...
     <h1 class="page-title">管理员显示</h1>
<div class="btn-toolbar">
    <button class="btn btn-primary"><i class="icon-plus"></i><a style="color:#fff;"href="/admin.php?c=admin&a=add">增加货物</a></button>
  <div class="btn-group">
  </div>
</div>
<div class="well">
    <table class="table">
      ...
      <?php if(is_array($res)): $i = 0; $__LIST__ = $res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
         ...
         <th><?php echo ($vo["email"]); ?></th>
          <td>
              <a href="" attr-id="<?php echo ($vo["id"]); ?> "role="button" class="adminId"  data-toggle="modal"><i class="icon-remove"></i></a>
          </td>
