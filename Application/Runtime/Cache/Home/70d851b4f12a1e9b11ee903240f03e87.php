    ...
    <div class="i-tab mg-auto overflow area clearfix">
      ...
      <div class="tab-content clearfix overflow" id="con1">
        <div class="clearfix tab-con2 ">
        	<?php if(is_array($res)): $i = 0; $__LIST__ = $res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><ul class="clearfix">
                   <li style="background-color:white;"
                   <a href="http://wuliu.gcshop.cc/index.php/fahuo/detail/1" class="tab-con-href2 clearfix">
