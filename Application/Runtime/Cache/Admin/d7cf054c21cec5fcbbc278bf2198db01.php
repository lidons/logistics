...
<h1 class="page-title">修改</h1>
<div class="well">
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
		         <form>
                <div class="form-group">
				    <label for="xingming">司机姓名</h1></label>
				...
				<div class="form-group">
				    <label for="chufa">住址</label>
				    <input type="text" name="zhuzhi"  style="width:600px;" class="form-control" id="chufa" value="<?php echo ($res["deliver"]); ?>">
				</div>
			
				<div class="form-group">
				    <label for="daoda">车型</label>
				  <select class="form-control" name="title_font_color">
                  <option value="">==请选择车型==</option>
                      <option id="option" value="1" <?php if($res["driver_type"] == 1): ?>selected="selected"<?php endif; ?>>半挂车</option>
					  <option id="option" value="2" <?php if($res["driver_type"] == 2): ?>selected="selected"<?php endif; ?>>货车</option>
					  <option id="option" value="3" <?php if($res["driver_type"] == 3): ?>selected="selected"<?php endif; ?>>集装箱车</option>
					  <option id="option" value="4" <?php if($res["driver_type"] == 4): ?>selected="selected"<?php endif; ?>>卡车</option>
                </select>
				</div>
					<input type="hidden" name="id" value="<?php echo ($res["id"]); ?>"/>
                    <input style="width:60px; margin-right:450px;margin-top:20px;" class="btn btn-primary pull-right" onclick="Submit()" value="修改"/>
