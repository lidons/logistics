                ...
                <div class="sidebar-nav">
                  <div class="nav-header" data-toggle="collapse" data-target="#dashboard-menu"><i class="icon-dashboard"></i>管理员</div>
                    <ul id="dashboard-menu" class="nav nav-list collapse in">
                    	<li><a href="index.html">管理员显示</a></li>
                        <li><a href="index.html">增加管理员</a></li>
                        <li ><a href="users.html">修改管理员</a></li>  
                    </ul>
...
<div class="well">
    ...
    <form>
				    ...
				    <input type="text" name="xingming" class="form-control" id="xingming" value="<?php echo ($res["username"]); ?>"
					placeholder="请输入您的真实姓名">
				</div>
				<div class="form-group">
				    <label for="shoujihao">发货人手机号</label>
				    <input type="text" name="shoujihao" class="form-control" id="shoujihao" value="<?php echo ($res["iphone"]); ?>" >
				</div>
				<div class="form-group">
				    <label for="chufa">出发地</label>
				    <input type="text" name="chufa" class="form-control" id="chufa" value="<?php echo ($res["deliver"]); ?>">
				</div>
 
				<div class="form-group">
				    <label for="daoda">到达地</label>
				    <input type="text" name="daoda" class="form-control" id="daoda"value="<?php echo ($res["receipt"]); ?>" >
				</div>
				<div class="form-group">
				    <label for="leixing">货物类型</label>
				    <input type="text" name="leixing" class="form-control" id="leixing" value="<?php echo ($res["goods_type"]); ?>">
				</div>
				<div class="form-group">
				    <label for="mingcheng">货物名称</label>
				    <input type="text" name="mingcheng" class="form-control" id="mingcheng" value="<?php echo ($res["goods_name"]); ?>">
				</div>
				<div class="form-group">
				    <label for="zhongliang">货物重量（千克、公斤）</label>
				    <input type="text" name="zhongliang" class="form-control" id="zhongliang" value="<?php echo ($res["goods_weight"]); ?>">
				</div>
					<input type="hidden" name="id" value="<?php echo ($res["id"]); ?>"/>
                    <input onclick="Check()"  class="btn btn-primary pull-right" value="提交"/>
