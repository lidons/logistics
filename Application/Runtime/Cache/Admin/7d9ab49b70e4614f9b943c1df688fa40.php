...
<script type="text/javascript" charset="utf-8" src="javascripts/graphDemo.js"></script>
    ...
    <h1 class="page-title">主页轮播图</h1>

    <div class="block">
        <p class="block-heading">大小为640*327，请按格式上传，过大过小都会让图片失真</p>
        <div class="block-body gallery">
				<?php if(is_array($res)): $i = 0; $__LIST__ = $res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><img src="<?php echo ($vo["thumb"]); ?>" alt="#" title="#" width="640px" height="327px" />
				<form   method='post' action="/admin.php?c=carousel&a=upload&p=<?php echo ($vo["id"]); ?>" enctype="multipart/form-data">
					<input name="image" type="file" />
					<input type="submit" style="margin-right: 300px" class="btn btn-primary pull-right"  value="修改图片" >
