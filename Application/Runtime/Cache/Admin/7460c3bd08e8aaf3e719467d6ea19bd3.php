...
<div class="btn-toolbar">
    <button class="btn btn-primary"><i class="icon-plus"></i><a style="color:#fff;"href="/admin.php?c=goods&a=add">增加货物</a></button>
  <div class="btn-group">
  </div>
</div>
<div class="well">
    <table class="table">
      ...
      <?php if(is_array($res)): $i = 0; $__LIST__ = $res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
          ...
          <th><?php echo ($vo["receipt"]); ?></th>
          <th><?php echo ($vo["goods_name"]); ?></th>
          <th><?php echo ($vo["date"]); ?></th>
          <th><?php echo ($vo["goods_weight"]); ?>kg</th>
          <td>
              <a href="/admin.php?c=goods&a=edit&id=<?php echo ($vo["id"]); ?>"><i class="icon-pencil"></i></a>
              <a href="" attr-id="<?php echo ($vo["id"]); ?> "role="button" class="showId"  data-toggle="modal"><i class="icon-remove"></i></a>
          </td>
